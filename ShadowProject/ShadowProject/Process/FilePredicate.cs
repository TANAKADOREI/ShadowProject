...
namespace ShadowProject
{
    public partial class ShadowProjectProccessor
    {
        ...
        {
            return DateDB__CompareDate(m_sql, SQL_TABLE__LASTMODIFIEDTIME, source.FullName, source.LastWriteTimeUtc);
        }

        private bool ComparePredicate__LastAccessedDate(FileInfo source)
        {
            return DateDB__CompareDate(m_sql, SQL_TABLE__LASTACCESSEDTIME, source.FullName, source.LastAccessTimeUtc);
        }
